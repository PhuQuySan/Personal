...
import {
    ...
    User, ChevronDown, Menu, X, Home, Moon, Sun, Columns, Rows, FileText, Image as ImageIcon, Settings
} from 'lucide-react';
import { usePathname, useRouter } from 'next/navigation';
import { useEffect, useState, useMemo, useCallback, useTransition } from 'react';
import { createClient } from '@/shared/lib/supabase/client';
import { UserRole, NavLink } from '@/shared/types';
import { usePrefetch, usePrefetchCritical } from '@/shared/hooks/usePrefetch';
import { useCachedUserProfile, clearAllCache } from '@/shared/hooks/useCachedData';
...
export const Navigation: React.FC = () => {
    ...
    const { data: userProfile, isStale, loading } = useCachedUserProfile();
...
const MobileSidebar = ({ isSidebarOpen, closeSidebar, allLinks, NavItem, isDarkMode, toggleDarkMode, isAuthenticated, userProfile, userRole, handleSignOut, prefetchOnHover, isPending, loading }: any) => (
